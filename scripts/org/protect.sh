  ...
  --input - <<'JSON'
{
  "required_status_checks": {
    "strict": true,
    "checks": [
      {"context": "DCO sign-off check", "app_id": 15368},
      {"context": "CycloneDX SBOM", "app_id": 15368},
      {"context": "Orphan module guard", "app_id": 15368},
      {"context": "Demo smoke paths", "app_id": 15368},
      {"context": "Zero-dependency boot (no Redis, no Postgres, no ClickHouse)", "app_id": 15368},
      {"context": "Lint & Import Verification", "app_id": 15368},
      {"context": "Full Test Suite", "app_id": 15368},
      {"context": "DoD ATO Evidence Gate", "app_id": 15368},
      {"context": "Dependency Security Scan", "app_id": 15368},
      ...
      {"context": "Production Secret Gate", "app_id": 15368},
      {"context": "Live Postgres Deployment Gate", "app_id": 15368},
      {"context": "Helm Chart Lint", "app_id": 15368},
      {"context": "Stress Harness (smoke)", "app_id": 15368},
      {"context": "Detection Efficacy Benchmark", "app_id": 15368},
