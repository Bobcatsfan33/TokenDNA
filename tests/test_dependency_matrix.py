...
def test_production_observability_dependencies_are_aligned_when_installed() -> None:
    expected = {
    ...
    try:
        ...
        pytest.skip("production-only OpenTelemetry dependencies are not installed")
